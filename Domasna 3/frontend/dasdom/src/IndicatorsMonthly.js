...
const IndicatorsMonthly = () => {
    ...
    useEffect(() => {
        fetch('http://localhost:8080/api/indicators/monthly')
    ...
    const handleFilter = () => {
        if (filterType === "id") {
            fetch(`http://localhost:8080/api/indicators/monthly/${filter}`)
                .then(response => response.json())
            ...
            fetch(`http://localhost:8080/api/indicators/monthly/symbol/${filter}`)
                .then(response => response.json())
        ...
        <h2>Daily Indicators</h2>
                ...
                <table>
                    ...
                    {filteredData.length === 0 ? (
                        ...
                        </tr> // Show loading message if no data
                    ) : (
...
export default IndicatorsMonthly;
